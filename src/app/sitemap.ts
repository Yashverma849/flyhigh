...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/tools/transit-time`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${base}/tools/incoterms`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${base}/tools/hs-code`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${base}/tools/documents`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    ...
    { url: `${base}/resources/glossary`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
