...
import { toIndustryOverview } from "@/lib/industry-overview";
import { IndustryOverviewCard } from "@/components/marketing/industry-overview-card";
...
export function IndustryOverviewSlider({ industrySlugs }: Props) {
    ...
    >
      ...
      >
        {overviews.map((overview) => (
          <IndustryOverviewCard key={overview.slug} overview={overview} />
        ))}
      </div>
    </div>
  );
