      ...
      <div className="relative z-10 flex flex-1 flex-col p-6 sm:p-8">
        ...
        >
          ...
          >
            ...
            <div className="f-display mt-1 text-xl text-white sm:text-2xl">{overview.eta}</div>
          </div>
          <div
            className="p-4"
            style={{ background: "rgba(10,10,12,0.55)", backdropFilter: "blur(8px)" }}
          >
            ...
            <div className="f-display mt-1 text-xl text-white sm:text-2xl">{overview.coverage}</div>
          </div>
        </div>
