...
import { getRouteBySlug } from "@/server/db/seed/routes";
import { toRouteOverview } from "@/lib/route-overview";
import { RouteOverviewCard } from "@/components/marketing/route-overview-card";
...
export function RouteOverviewSlider({ routeSlugs }: Props) {
    ...
    >
      ...
      >
        {overviews.map((overview) => (
          <RouteOverviewCard key={overview.slug} overview={overview} />
        ))}
      </div>
    </div>
  );
